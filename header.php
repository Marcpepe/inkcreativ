...
<head>
    ...
    <title>Phillimore</title>
    <meta name="description" content="" />
    <meta name="author" content="" />
    <meta name="copyright" content="INK,Copyright (c) 2015" />
...
<body class="topinitial">

    <div class="contain-to-grid row fullwidth" id="topbar">
        <nav class="top-bar" data-topbar="" role="navigation">
            ...
            <section class="top-bar-section">
                <ul class="left large-offset-2">
                 ...
                 <ul class="right">
                    <li><a class="icon" href="#">Connexion</a></li>
                </ul>
            </section>
        </nav>
    </div>